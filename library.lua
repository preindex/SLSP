...
unlockmodulescript = 'Unlocks a module script.'
...
mouse2click = ''
getinfo = debug.info
sethiddenproperty = sethiddenprop
writefile = 'Writes data to a file.'
getnilinstances = 'Returns all the instances parented to nil.'
loadfile = 'Loads the given, similar to loadstring.'
bit = ''
bit.bdiv = 'Divides dividend by divisor, remainder is not returned.sssssssssssssssssss'
...
syn_crypt_decrypt = ''
mouse2press = syn_mouse2press
syn_crypt_derive = ''
readbinarystring = '' -- idk
mouse1press = syn_mouse1press
syn_crypt_b64_decode = ''
appendfile = syn_io_append
...
syn_keyrelease = 'Releases the key given.'